...
const FilterModal = ({
  ...
  const filterOptions = [
    { value: 'base', label: 'Identity mapping' },
    { value: 'raise', label: 'Sharpening' },
    { value: 'gauss', label: 'Gaussian filter' },
    { value: 'rect', label: 'Rectangular blur' },
  ]
  ...
  return (
    <div className='filter-modal'>
      ...
      <div className="filter-btns">
        ...
        <Checkbox checked={ isPreview } onClick={ handlePreview }>Preview</Checkbox>
